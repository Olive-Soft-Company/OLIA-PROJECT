...
from olia.utils import logger
from olia.utils.audit import AuditLevel, AuditLoggingMiddleware
from olia.utils.logger import start_logger
...
from olia.internal.db import ScopedSession, engine, get_session

from olia.models.functions import Functions
from olia.models.models import Models
from olia.models.users import UserModel, Users
...
from olia.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
    get_filtered_models,
)
from olia.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
)
from olia.utils.actions import chat_action as chat_action_handler
from olia.utils.embeddings import generate_embeddings
from olia.utils.middleware import (
    build_chat_response_context,
    process_chat_payload,
    process_chat_response,
)

from olia.utils.auth import (
    get_license_data,
...
from olia.utils.plugin import install_tool_and_function_dependencies
from olia.utils.oauth import (
...
from olia.utils.security_headers import SecurityHeadersMiddleware
from olia.utils.redis import get_redis_connection

from olia.tasks import (
...
from olia.utils.redis import get_sentinels_from_env
...
if ENABLE_OTEL:
    from olia.utils.telemetry.setup import setup as setup_opentelemetry
...
from olia.utils.access_control import migrate_access_control
        ...
        if request.method == "GET":
            ...
            if "shared" in query_params and len(query_params["shared"]) > 0:
                ...
                if text:
                    ...
                    if urls:
                        from olia.retrieval.loaders.youtube import _parse_video_id
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for OLIA.
