...
from olia.routers.retrieval import search_web as _search_web
from olia.retrieval.utils import get_content_from_url
...
from olia.routers.memories import (
    query_memory,
...
from olia.models.notes import Notes
from olia.models.chats import Chats
from olia.models.channels import Channels, ChannelMember, Channel
from olia.models.messages import Messages, Message
from olia.models.groups import Groups
...
async def execute_code(
    ...
    try:
        ...
        from olia.config import CODE_INTERPRETER_BLOCKED_MODULES
        ...
        if __user__ and __user__.get("id"):
            ...
            from olia.utils.files import get_image_url_from_base64
...
async def view_note(
    ...
    try:
        ...
        from olia.models.access_grants import AccessGrants
...
async def write_note(
    ...
    try:
        from olia.models.notes import NoteForm
...
async def replace_note_content(
    ...
    try:
        from olia.models.notes import NoteUpdateForm
...
async def view_knowledge_file(
    ...
    try:
        from olia.models.files import Files
        from olia.models.knowledge import Knowledges
        from olia.models.access_grants import AccessGrants
...
async def query_knowledge_files(
    ...
    try:
        ...
        from olia.models.files import Files
        from olia.models.notes import Notes
        from olia.retrieval.utils import query_collection
        from olia.models.access_grants import AccessGrants
...
async def query_knowledge_bases(
    ...
    try:
        import heapq
        from olia.models.knowledge import Knowledges
        from olia.routers.knowledge import KNOWLEDGE_BASES_COLLECTION
...
async def view_skill(
    ...
    try:
        from olia.models.skills import Skills
        from olia.models.access_grants import AccessGrants
