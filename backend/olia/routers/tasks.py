...
from olia.routers.pipelines import process_pipeline_inlet_filter

from olia.utils.task import get_task_model_id
...
async def check_active_chats(
    ...
    from olia.tasks import get_active_chat_ids
