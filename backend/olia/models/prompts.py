...
from olia.models.prompt_history import PromptHistories
from olia.models.access_grants import AccessGrantModel, AccessGrants
...
class PromptsTable:
    ...
    def search_prompts(
        ...
        with get_db_context(db) as db:
            from olia.models.users import User, UserModel
