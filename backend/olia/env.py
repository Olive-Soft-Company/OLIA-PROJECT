...
OLIA_FAVICON_URL = "static\favicon.png"
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("olia")}
else:
    try:
...
try:
    ...
    changelog_content = (pkgutil.get_data("olia", "CHANGELOG.md") or b"").decode()
...
if FROM_INIT_PY:
    ...
    if DATA_DIR.exists() and DATA_DIR != NEW_DATA_DIR:
        ...
        shutil.make_archive(DATA_DIR.parent / "olia_data", "zip", DATA_DIR)
...
DATABASE_URL = os.environ.get("DATABASE_URL", f"sqlite:///{DATA_DIR}/olia.db")
...
if all(DB_VARS.values()):
    ...
    DATABASE_URL = f"sqlite+sqlcipher:///{DATA_DIR}/olia.db"
...
REDIS_KEY_PREFIX = os.environ.get("REDIS_KEY_PREFIX", "olia")
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "olia")
