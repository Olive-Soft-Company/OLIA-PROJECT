...
from olia.env import PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS, OFFLINE_MODE
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from olia.utils",
        "from apps": "from olia.apps",
        "from main": "from olia.main",
        "from config": "from olia.config",
    }
