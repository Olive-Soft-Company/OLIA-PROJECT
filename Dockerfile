...
ARG OLIA_AUTH_SIGNOUT_REDIRECT_URL
...
ARG ATLASSIAN_CLIENT_ID
ARG ATLASSIAN_CLIENT_SECRET
ARG ATLASSIAN_REDIRECT_URI
...
ENV GOOGLE_DRIVE_CLIENT_ID=${GOOGLE_DRIVE_CLIENT_ID} \
    ...
    OLIA_AUTH_SIGNOUT_REDIRECT_URL=${OLIA_AUTH_SIGNOUT_REDIRECT_URL} \
    ...
    OLIA_SECRET_KEY=${OLIA_SECRET_KEY} \
