<script lang="ts">
	...
	import { OLIA_NAME, config, user, showSidebar } from '$lib/stores';
...
> 
> OLIA is completely free to use as-is, with no restrictions or hidden limits, and we'd love to keep it that way. 🌱  
>
