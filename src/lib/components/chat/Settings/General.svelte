<script lang="ts">
	...
	import { OLIA_NAME,config, models, settings, theme, user } from '$lib/stores';
...
<div class="flex flex-col h-full justify-between text-sm" id="tab-general">
	<div class="  overflow-y-scroll max-h-[28rem] md:max-h-full">
		<div class="">
			<div class=" mb-1 text-sm font-medium">{$OLIA_NAME}{$i18n.t(' Settings')}</div>
