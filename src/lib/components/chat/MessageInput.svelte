<script lang="ts">
	...
	import { OLIA_BASE_URL, OLIA_API_BASE_URL, PASTED_TEXT_CHARACTER_LIMIT } from '$lib/constants';
									...
									<div class="flex items-center justify-between w-full">
										<div class="pl-[1px] flex items-center gap-2 text-sm dark:text-gray-500">
											<img
												...
												src={`${OLIA_API_BASE_URL}/models/model/profile/image?id=${$models.find((model) => model.id === atSelectedModel.id).id}&lang=${$i18n.language}`}
											/>
